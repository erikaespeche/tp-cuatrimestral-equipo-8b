<%@ Page Title="" Language="C#" MasterPageFile="~/PerfilAdministrador.Master" AutoEventWireup="true" CodeBehind="GestionarProfesionalesAdm.aspx.cs" Inherits="ClinicaWeb.Pantasllas_Perfil_Administrador.GestionarProfesionalesAdm" %>
                ...
                <div class="modal-header border-secondary">
                    <h5 class="modal-title fw-bold" id="modalVerLabel">
                        <span class="material-symbols-outlined"
                            style="font-size: 26px; color: #007BFF; line-height: 1; transform: translateY(4px);">person
                        </span>
                    ...
                    <div class="d-flex align-items-center gap-3 pb-3 mb-3 border-bottom border-secondary">
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            ...
                            <span class="material-symbols-outlined d-flex align-items-center justify-content-center"
                                style="font-size: 40px; color: #007BFF; line-height: 1; transform: translate(1px, -6px);">person
                            </span>
                        </div>
            ...
            <div class="modal-content modal-turno-dark">
                ...
                <div class="modal-header d-flex align-items-center gap-3 pb-3 mb-3 border-bottom border-secondary">
                    <div class="d-flex align-items-center justify-content-center"
                        ...
                        <span class="material-symbols-outlined d-flex align-items-center justify-content-center"
                            style="font-size: 40px; color: #FFC107; line-height: 1; transform: translate(1px, -6px);">edit
                        </span>
                    </div>
            ...
            <div class="modal-content modal-turno-dark">
                ...
                <div class="modal-header d-flex align-items-center gap-3 pb-3 mb-3 border-bottom border-secondary">
                    ...
                    <div class="d-flex align-items-center justify-content-center"
                        ...
                        <span class="material-symbols-outlined d-flex align-items-center justify-content-center"
                            style="font-size: 40px; color: #DC3545; line-height: 1; transform: translate(1px, -6px);">delete
                        </span>
                    </div>
