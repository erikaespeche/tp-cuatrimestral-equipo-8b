...
{
    public partial class GestionarEspecialidadesAdm : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("AgregarNuevaEspecialidadAdm.aspx");
        }
        ...
        protected void repEspecialidades_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("EditarEspecialidadAdm.aspx?id=" + idEspecialidad);
                return;
            }
