<%@ Page Title="Clinica - Agregar Profesional" Language="C#" MasterPageFile="~/PerfilRecepcionista.Master"
    AutoEventWireup="true" CodeBehind="AgregarNuevoProfesional.aspx.cs"
    Inherits="Clinic.Pantallas_Perfil_Recepcionista.AgregarNuevoProfesional" %>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm mt-2"
                                    onclick="window.location='AgregarNuevaEspecialidad.aspx?volver=agregarMedico'">
